...
enum class AuraRoute(
    ...
    AI_ASSISTANT("AI DJ", Icons.Filled.AutoAwesome, Icons.Outlined.AutoAwesome),
    QUEUE("Queue", Icons.Filled.QueueMusic, Icons.Outlined.QueueMusic),
    AI_INSIGHTS("Music Insights", Icons.Filled.Analytics, Icons.Outlined.Analytics),
    SOCIAL("Social", Icons.Filled.People, Icons.Outlined.People),
